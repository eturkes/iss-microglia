...
o.FileBase{3} = 'r2001';
o.FileBase{4} = 'r3001';
o.FileBase{5} = 'r4001_old';
o.FileBase{6} = 'r5001';
o.FileBase{7} = 'r6001';
o.FileBase{8} = 'Anchor001';    %Make sure the last round is the anchor

o.TileDirectory = fullfile('cache', 'NLF-133genes', 'CTRL', 'tiles');
o.OutputDirectory = fullfile('cache', 'NLF-133genes', 'CTRL', 'output');
...
% o.PcImageMatchesThresh = 33;
o.PcImageMatchesThresh = 31;
